			...
			<div className="w-full">
				...
				>
					<BaseSelect.Trigger
						ref={ref}
						id={selectId}
						className={`flex w-full items-center justify-between gap-3 rounded-md border border-gray-200 bg-white text-gray-900 select-none hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-primary data-[popup-open]:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed ${
							size === "sm"
								? "h-8 px-2 text-sm"
								: size === "lg"
									? "h-12 px-4 text-base"
