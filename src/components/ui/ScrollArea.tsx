		...
		return (
			...
			>
				...
				{(orientation === "vertical" || orientation === "both") && (
					...
					>
						<BaseScrollArea.Thumb className="flex-1 bg-gray-300 rounded-[10px] relative before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-full before:h-full before:min-w-[14px] before:min-h-full" />
					</BaseScrollArea.Scrollbar>
				)}
				{(orientation === "horizontal" || orientation === "both") && (
					...
					>
						<BaseScrollArea.Thumb className="flex-1 bg-gray-300 rounded-[10px] relative before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-full before:h-full before:min-w-full before:min-h-[14px]" />
					</BaseScrollArea.Scrollbar>
				)}
